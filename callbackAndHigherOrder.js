...
// CODE HERE
const multiply = (num1,num2,callbackFn) => callbackFn(num1*num2);
...
// CODE HERE 
const first = (arr,callbackFn) => {callbackFn(arr[0])}
...
// CODE HERE
const last = (arr, callbackFn) => callbackFn(arr[arr.length-1])
...
// CODE HERE 
const each = (arr, callbackFn) => arr.forEach((element,i) => callbackFn(element,i))
...
console.log(addEleven(1))
console.log(addEleven(1000))
